...
- Debounced autosave exports and validates the OpenMIDI manifest, uploads an immutable private JSON recovery snapshot, and saves with an expected workspace `lock_version`.
