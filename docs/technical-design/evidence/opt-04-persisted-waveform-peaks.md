...
- Local Chromium studio journey: delays canonical source delivery and asserts the accessible persisted-waveform state and derived-object response occur first.
