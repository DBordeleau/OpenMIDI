...
export async function SignInContent({
  ...
  return (
    <>
      {/* The wordmark anchors the card when sign-in is reached directly.
          Everything else is type and space, not ornament. */}
      ...
      <p className="text-muted mt-4 text-xs leading-relaxed">
        By continuing you agree to keep the community rules — only publish work
