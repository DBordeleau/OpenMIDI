...
insert into public.arrangement_versions(id,project_id,created_by,create_request_id,manifest_version,engine,engine_version,manifest,manifest_sha256,tempo_bpm,time_signature_numerator,time_signature_denominator,musical_key,ppq,duration_ticks) values('fd210000-0000-4000-8000-000000000001','fd200000-0000-4000-8000-000000000001','fd000000-0000-4000-8000-000000000004',gen_random_uuid(),3,'openmidi-midi','openmidi-midi-3_tone-15.1.22_presets-1','{}',repeat('a',64),120,4,4,'c-major',480,960);
insert into public.project_revisions(id,project_id,revision_number,created_by,publish_request_id,manifest,manifest_version,engine,engine_version,manifest_sha256,duration_ms,arrangement_version_id) values('fd220000-0000-4000-8000-000000000001','fd200000-0000-4000-8000-000000000001',1,'fd000000-0000-4000-8000-000000000004',gen_random_uuid(),'{}',3,'openmidi-midi','openmidi-midi-3_tone-15.1.22_presets-1',repeat('b',64),1000,'fd210000-0000-4000-8000-000000000001');
